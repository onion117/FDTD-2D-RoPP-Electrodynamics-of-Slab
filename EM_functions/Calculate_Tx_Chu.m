function [ Tx,t1,t2,t3,t4,t5] = Calculate_Tx_Chu (i,j,Ex,Ey,Dx,Dy,Hz,Hz_n_prev,Bz,Bz_n_prev,dx,dy )
...
t5=(1/(2*dy))*(Ex2.*Ey(i,j+1)-Ex1.*Ey(i,j-1));


Tx(i,j)=(0.5)*eps_o.*(t1+t2)+0.5*(mu_o).*t3-eps_o.*t4-eps_o.*t5;
end